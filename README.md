...
3. Employees List API Response


4. Single Employee Detail Response


5. Create Employee API Request


6. Create Employee API Response


7. Update Employee API Request


8. Update Employee API Response


9. Soft Delete Employee API Response


10. Restore Employee API Request


11. Restore Employee API Response
...
12. API Departments List Response


13. API Department Detail Response
